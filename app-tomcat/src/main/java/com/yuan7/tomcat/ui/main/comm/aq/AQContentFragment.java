    ...
    protected void bindData() {
        ...
        dataAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ContentEntity.User contentEntity = ((AQAdapter) adapter).getData().get(position).getUser();
...
//        progressLayout.setColorSchemeColors(Color.parseColor("#000000"));
    ...
    @Override
    public void bindAQData(int pageNo, ResultDataEntity<ContentEntity> result) {
