    ...
    protected void bindData() {
        ...
        switch (mode) {
            ...
            case Constant.MENU_RECORD:
                mFragmentManager.beginTransaction().replace(R.id.control_container, new OrderFragment(this)).commit();
                break;
            ...
            case Constant.MENU_CODE:
                mFragmentManager.beginTransaction().replace(R.id.control_container, new CodeFragment(this)).commit();
                break;
        }
    }
