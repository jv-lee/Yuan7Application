...
public class SendActivity extends BaseActivity<SendContract.Presenter> implements SendContract.View {
    ...
    protected void bindData() {
        pDialog = new SweetAlertDialog(this, SweetAlertDialog.PROGRESS_TYPE);//创建登陆进度Alert
        pDialog.getProgressHelper().setBarColor(getResources().getColor(R.color.editColor));
