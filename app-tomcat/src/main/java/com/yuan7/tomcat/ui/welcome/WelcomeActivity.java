...
public class WelcomeActivity extends Activity implements SplashADListener{
    ...
    private void bindData() {
        ...
        fetchSplashAD(this, container, skipView, getString(R.string.gdt_appId), getString(R.string.gdt_kaiping_id), this, 0);
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(@NonNull Boolean aBoolean) throws Exception {
                        if (aBoolean) {
                            ...
                            finish();
                            overridePendingTransition(R.anim.alpha_in, R.anim.alpha_me_out);
                        }
