 ...
 */
public class UserSettingsFragmentSimple extends BaseFragment {
    ...
    public UserSettingsFragmentSimple(TitleBarListener listener) {
        ...
        if (alertIcon == null) {
            ...
            vIcon.findViewById(R.id.rl_photo).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    IconUtil.selectImage(UserSettingsFragmentSimple.this,REQUEST_IMAGE_GET);
            ...
            vIcon.findViewById(R.id.rl_camera).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    picPatch = IconUtil.dispatchTakePictureIntent(UserSettingsFragmentSimple.this, REQUEST_IMAGE_CAPTURE);
                    if (alertIcon.isShowing()) {
                        alertIcon.hide();
                    }
                }
