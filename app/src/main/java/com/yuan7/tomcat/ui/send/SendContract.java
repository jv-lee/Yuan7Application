...
public interface SendContract {
    ...
    interface Model extends IModel {
        Observable<String> doPostAddVideo(Map<String, Object> paramsMap, MultipartBody.Part file);

        Observable<String> doPostAddPicture(Map<String, Object> paramsMap, @PartMap Map<String, RequestBody> files);
    }
}
