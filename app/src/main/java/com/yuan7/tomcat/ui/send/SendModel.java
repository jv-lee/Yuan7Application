...
public class SendModel extends BaseModel implements SendContract.Model {
    ...
    @Override
    public Observable<String> doPostAddVideo(Map<String, Object> paramsMap, MultipartBody.Part file) {
        return apiServer.doPostAddVideo(paramsMap,file)
                .subscribeOn(Schedulers.io());
    }

    @Override
    public Observable<String> doPostAddPicture(Map<String, Object> paramsMap, @PartMap Map<String, RequestBody> files) {
