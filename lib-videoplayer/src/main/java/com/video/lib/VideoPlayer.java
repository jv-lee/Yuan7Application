...
public abstract class VideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public void init(Context context) {
        ...
        startButton = (ImageView) findViewById(com.video.lib.R.id.start);
        fullscreenButton = (ImageView) findViewById(com.video.lib.R.id.fullscreen);
        progressBar = (SeekBar) findViewById(com.video.lib.R.id.bottom_seek_progress);
        currentTimeTextView = (TextView) findViewById(com.video.lib.R.id.current);
        totalTimeTextView = (TextView) findViewById(com.video.lib.R.id.total);
        bottomContainer = (ViewGroup) findViewById(com.video.lib.R.id.layout_bottom);
        textureViewContainer = (ViewGroup) findViewById(com.video.lib.R.id.surface_container);
        topContainer = (ViewGroup) findViewById(com.video.lib.R.id.layout_top);
    ...
    public void onClick(View v) {
        ...
        } else if (i == com.video.lib.R.id.fullscreen) {
        ...
        } else if (i == com.video.lib.R.id.surface_container && currentState == CURRENT_STATE_ERROR) {
...
//            int duration = getDuration();
    ...
    public static boolean backPress() {
        ...
        if (VideoPlayerManager.getSecondFloor() != null) {
            ...
            jcVideoPlayer.onEvent(jcVideoPlayer.currentScreen == VideoPlayerStandard.SCREEN_WINDOW_FULLSCREEN ?
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public void startWindowTiny() {
        ...
        try {
            ...
            vp.addView(jcVideoPlayer, lp);
            jcVideoPlayer.setUp(url, VideoPlayerStandard.SCREEN_WINDOW_TINY, objects);
            jcVideoPlayer.setUiWitStateAndScreen(currentState);
            jcVideoPlayer.addTextureView();
            VideoPlayerManager.setSecondFloor(jcVideoPlayer);
...
//    }
    ...
    public static void startFullscreen(Context context, Class _class, String url, Object... objects) {
        ...
        try {
            ...
            final VideoPlayer jcVideoPlayer = constructor.newInstance(context);
            jcVideoPlayer.setId(VideoPlayer.FULLSCREEN_ID);
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            vp.addView(jcVideoPlayer, lp);
