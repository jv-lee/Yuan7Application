...
public class VideoAdapter extends BaseQuickAdapter<VideoBean.ResultBean, BaseViewHolder> {

    public VideoAdapter(@Nullable List<VideoBean.ResultBean> data) {
        super(R.layout.item_video, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, VideoBean.ResultBean item) {
        if (item != null) {
